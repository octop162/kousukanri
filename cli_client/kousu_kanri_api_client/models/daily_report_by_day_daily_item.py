...
T = TypeVar("T", bound="DailyReportByDayDailyItem")


@_attrs_define
class DailyReportByDayDailyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        daily_report_by_day_daily_item = cls(
            date=date,
        ...
        daily_report_by_day_daily_item.additional_properties = d
        return daily_report_by_day_daily_item
